...
p <- ggplot(hearing_data2, aes(x=R2k)) + geom_histogram(color="black", fill="white", breaks = seq(5, 40, by = 5)) +
  labs(x="Right Ear 2000 hz Frequency")
p
```
Graph showing the distribution of Right ear hearing threshold value for 2000 Hz frequency Each interval of 5 represents the hearing level in decibels (dB), less meaning it's better. When above 25 dB, that means that a worker is said to have developed 'material hearing impairment'. Each bucket represents the total number of people who had a hearing level at 2000 hz frequency. 
